...
/*解析文件中的代码*/
exports.parseIndex = function (opts) {
	var indexFile = opts.indexFile;
	var configJson = opts.configJson;
	var mergeCssPath = opts.mergeCssPath;
	var mergeJsPath = opts.mergeJsPath;
	parseIndex(indexFile,configJson,mergeCssPath,mergeJsPath)
};
/*解析文件中的代码*/
exports.parseHtml = function (opts) {
	var indexFileDir = opts.indexFileDir;
	var configJson = opts.configJson;
	var mergeCssPath = opts.mergeCssPath;
	var mergeJsPath = opts.mergeJsPath;
...
/*拷贝文件*/
exports.copy = require("./rap.copy.static.js").copy;
